              ...
              <div class="card">
                ...
                <div class="comment-widgets scrollable">
                  ...
                  <div class="d-flex flex-row comment-row">
                    <div class="p-2">
                      <img
                        src="{{ asset('be/assets/images/users/5.jpg') }}"
                        alt="user"
                        width="50"
                        class="rounded-circle"
                      />
                        ...
                        <ul class="list-style-none assignedto">
                          ...
                          <li class="assignee">
                            <img
                              class="rounded-circle"
                              width="40"
                              src="{{ asset('be/assets/images/users/2.jpg') }}"
                              alt="user"
                              data-toggle="tooltip"
                              data-placement="top"
                              title=""
                          ...
                          <li class="assignee">
                            <img
                              class="rounded-circle"
                              width="40"
                              src="{{ asset('be/assets/images/users/3.jpg') }}"
                              alt="user"
                              data-toggle="tooltip"
                              data-placement="top"
                              title=""
                          ...
                          <li class="assignee">
                            <img
                              class="rounded-circle"
                              width="40"
                              src="{{ asset('be/assets/images/users/4.jpg') }}"
                              alt="user"
                              data-toggle="tooltip"
                              data-placement="top"
                              title=""
                ...
                <div class="tab-content tabcontent-border">
                  <div class="tab-pane active" id="home" role="tabpanel">
                    <div class="p-20">
                      ...
                      <img
                        src="{{ asset('be/assets/images/background/img4.jpg') }}"
                        class="img-fluid"
                      />
                    </div>
                  </div>
